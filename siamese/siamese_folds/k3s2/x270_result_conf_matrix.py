...
for k in range(num_folds):
    ...
    fname='{}/nrec_outputs.pickle'.format(resdir)
    with open(fname, 'rb') as handle:
        print ("load output from: {}".format(fname))
    ...
    true_outputs=input2_target_arr[:,2].astype(int) #transpose the third columns
    ...
    cm = confusion_matrix(true_outputs, int_outputs)
    print(cm)
