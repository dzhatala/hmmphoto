...
static int featureType=1;            /* repetition of named label */
...
void ReportUsage(void)
{
   ...
   */
   ...
   printf(" -f t    type (t) of feature, t= 1 2 or 3 ...\n");
   PrintStdOpts("S");
...
int main(int argc, char *argv[])
{
   ...
   */
   ...
   while (NextArg() == SWITCHARG) {
      ...
      case 'f': /*feature type*/
         if (NextArg()!=INTARG)
            HError(20000,"feature type expected 1: 15(gray_lee)");
         featureType = GetChkedInt(0,1,s); 
